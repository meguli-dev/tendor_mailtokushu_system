...
\`\`\`json
{
  "intro_text": "（導入文。この特集で紹介する商品カテゴリの魅力を3-4文で説明。具体的なメリットや課題解決を含める）",
  "recommend_descriptions": ["（おすすめ商品1の説明文。なぜおすすめなのか具体的に2-3文で）", "（おすすめ商品2の説明文）"],
  "selection_guide_title": "（選び方セクションのタイトル、例: こんなポイントで選ぼう）",
  "selection_guide_cards": [
    {"title": "（選び方ポイント1のタイトル、短く）", "description": "（選び方ポイント1の説明。具体的に2-3文で）"},
    {"title": "（選び方ポイント2のタイトル）", "description": "（選び方ポイント2の説明）"},
    {"title": "（選び方ポイント3のタイトル）", "description": "（選び方ポイント3の説明）"}
  ],
  "use_cases": [
    {"title": "（利用シーン1のタイトル）", "description": "（利用シーン1の説明。具体的に2文で）"},
    {"title": "（利用シーン2のタイトル）", "description": "（利用シーン2の説明）"},
    {"title": "（利用シーン3のタイトル）", "description": "（利用シーン3の説明）"}
  ],
  "faq": [
